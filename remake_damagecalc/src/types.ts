...
export enum EnemyAttackName {
  ...
  MIGRAINE = "Migraine",
  MISSED_ME = "Missed me!",
  MONSTER_TOSS = "Monster Toss",
  MULTISTRIKE = "Multistrike",
  PAIN_SPOUT = "Painspout",
  PETAL_BLAST = "Petal Blast",
  PIERCE = "Pierce",
  POISON = "Poison",
  PSYCHE = "Psyche!",
  QUICKSILVER = "Quicksilver",
  REAPER_SICKLE = "Reaper Sickle",
...
export enum WeaponName {
  ...
  HURLY_GLOVE = "Hurly Glove (ぶんなげグローブ)",
...
export enum ArmorName {
  ...
  FLUFFY_SHIRT = "Fluffy Shirt (ふかふかつなぎ)",
  ...
  FLUFFY_PANTS = "Fluffy Pants (ふかふかパンツ)",
  ...
  FLUFFY_CAPE = "Fluffy Cape (ふかふかマント)",
  ...
  FLUFFY_DRESS = "Fluffy Dress (ふかふかドレス)",
...
export enum EnemyNames {
  ...
  BEEZO = "Beezo",
  BELOME_1 = "Belome (Sewers)",
  BELOME_2 = "Belome (Temple)",
  ...
  CROCO_1 = "Croco (Bandit's Way)",
  CROCO_2 = "Croco (Mole Mines)",
  CROOK = "Crook",
  CRUSTY = "Crusty",
  CULEX = "Culex",
  CULEX_3D = "Culex 3D",
  ...
  DIRECTOR = "Director",
  DODO_1 = "Dodo (Nimbus Castle)",
  DODO_2 = "Dodo (Valentina Fight)",
  DOLLOX = "Dollox",
  DOMINO = "Domino",
  ...
  JESTER = "Jester",
  JINNIE = "Jinnie",
  JINX_1 = "Jinx (Testing Capabilities)",
  JINX_2 = "Jinx (You Asked for It)",
  JINX_3 = "Jinx (Sensei in Action)",
  JINX_CLONE = "Jinx Clone",
  JINX_MARIO_STYLE = "Jinx (Mario-Style)",
  JOHNNY = "Johnny",
  JOHNNY_BOOST = "Johnny ('Get Tough')",
