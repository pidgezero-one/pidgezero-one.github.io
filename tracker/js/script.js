...
var db = openDatabase('FF4items', '1.0', 'tracker', 3 * 1024 * 1024);
						...
						'<div class="location-selector hidden">' +
							'<div class="linear-location-selector display-table ' + (mapSelectorStyle != "linear" ? "hidden" : "") + '">' +
								'<div class="display-row">' +
									'<div class="Baron display-cell"><span class="overworld">Baron</span><div class="pic" title="Baron"><div class="img"></div></div></div>' +
									'<div class="Mist display-cell"><span class="overworld">Mist</span><div class="pic" title="Mist"><div class="img"></div></div></div>' +
									'<div class="Kaipo display-cell"><span class="overworld">Kaipo</span><div class="pic" title="Kaipo"><div class="img"></div></div></div>' +
									'<div class="Toroia display-cell"><span class="overworld">Toroia</span><div class="pic" title="Toroia"><div class="img"></div></div></div>' +
									'<div class="Fabul display-cell"><span class="overworld">Fabul</span><div class="pic" title="Fabul"><div class="img"></div></div></div>' +
									'<div class="Silvera display-cell"><span class="overworld">Silvera</span><div class="pic" title="Silvera"><div class="img"></div></div></div>' +
									'<div class="Mysidia display-cell"><span class="overworld">Mysidia</span><div class="pic" title="Mysidia"><div class="img"></div></div></div>' +
									'<div class="Agart display-cell"><span class="overworld">Agart</span><div class="pic" title="Agart"><div class="img"></div></div></div>' +
									'<div class="Eblan display-cell"><span class="overworld">Eblan</span><div class="pic" title="Eblan"><div class="img"></div></div></div>' +
									'<div class="Dwarf display-cell"><span class="underworld">Dwarf</span><div class="pic" title="Dwarf"><div class="img"></div></div></div>' +
									'<div class="Tomra display-cell"><span class="underworld">Tomra</span><div class="pic" title="Tomra"><div class="img"></div></div></div>' +
									'<div class="LoS display-cell"><span class="underworld">LoS</span><div class="pic" title="LoS"><div class="img"></div></div></div>' +
									'<div class="Kokkol display-cell"><span class="underworld">Kokkol</span><div class="pic" title="Kokkol"><div class="img"></div></div></div>' +
									'<div class="Namingway display-cell"><span class="moon">Namingway</span><div class="pic" title="Namingway"><div class="img"></div></div></div>' +
								'</div>' +
							'</div>' +
							...
							'<div class="block-location-selector display-table ' + (mapSelectorStyle != "block" ? "hidden" : "") + '">' +
								...
								'<div class="display-row">' +
									'<div class="Eblan display-cell"><span class="overworld">Eblan</span><div class="pic" title="Eblan"><div class="img"></div></div></div>' +
									'<div class="display-cell empty"></div>' +
									'<div class="display-cell empty"></div>' +
									'<div class="Namingway display-cell"><span class="moon">Namingway</span><div class="pic" title="Namingway"><div class="img"></div></div></div>' +
								'</div>' +
								'<div class="display-row">' +
